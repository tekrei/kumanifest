...
public class TableSorter extends AbstractTableModel {
    ...
    public Object getObjectAt(int view) {
        Row r = viewToModel[view];
        GenericTableModel tblModel = (GenericTableModel) this.tableModel;

        return tblModel.getObjectAtRow(r.modelIndex);
    }

    public Vector getObjects(int[] at) {
        GenericTableModel tblModel = (GenericTableModel) this.tableModel;
        ...
        for (int i = 0; i < at.length; i++) {
            Row r = viewToModel[i];
            v.add(tblModel.getObjectAtRow(r.modelIndex));
        }
