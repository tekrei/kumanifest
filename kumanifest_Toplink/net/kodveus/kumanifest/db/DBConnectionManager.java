...
public class DBConnectionManager {
	 ...
	 */
	private void createPool(DBParameters props) {
		pool = new DBConnectionPool("ConPool", dbp.dbURL, dbp.dbUser,
				dbp.dbPassword, dbp.maxConnection);
	...
	private void loadDriver(DBParameters dbp) {
		try {
			...
			log("Can't register JDBC driver: " + dbp.dbDriver + ", Exception: "
					+ e);
		}
	}
	...
	private void log(String msg) {
		LogHelper.getLogger().info(new Date() + ": " + msg);
	}
